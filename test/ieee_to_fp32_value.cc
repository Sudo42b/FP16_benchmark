...
void test_ieee_to_fp32_value_normalized_powers_of_2() {
...
void test_ieee_to_fp32_value_denormalized_powers_of_2() {
...
void test_ieee_to_fp32_value_zero() {
...
void test_ieee_to_fp32_value_infinity() {
...
void test_ieee_to_fp32_value_positive_nan() {
	using std::signbit;
	using std::isnan;
...
void test_ieee_to_fp32_value_negative_nan() {
	using std::signbit;
	using std::isnan;
	for (uint16_t m = UINT16_C(1); m < UINT16_C(0x0400); m++) {
...
void test_ieee_to_fp32_value_positive_normalized_values() {
...
void test_ieee_to_fp32_value_negative_normalized_values() {
	const uint32_t exponentBias = 15;
	for (int32_t e = -14; e <= 15; e++) {
		for (uint16_t h = 0; h < 0x0400; h++) {
...
void test_ieee_to_fp32_value_positive_denormalized_values() {
	for (uint16_t h = 0; h < 0x0400; h++) {
...
void test_ieee_to_fp32_value_negative_denormalized_values() {
	for (uint16_t h = 0; h < 0x0400; h++) {
