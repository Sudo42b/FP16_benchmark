...
void test_alt_to_fp32_bits_normalized_powers_of_2() {
...
void test_alt_to_fp32_bits_denormalized_powers_of_2() {
...
void test_alt_to_fp32_bits_zero() {
...
void test_alt_to_fp32_bits_positive_normalized_values() {
...
void test_alt_to_fp32_bits_negative_normalized_values() {
	const uint32_t exponentBias = 15;
	for (int32_t e = -14; e <= 16; e++) {
		for (uint16_t h = 0; h < 0x0400; h++) {
...
void test_alt_to_fp32_bits_positive_denormalized_values() {
	for (uint16_t h = 0; h < 0x0400; h++) {
...
void test_alt_to_fp32_bits_negative_denormalized_values() {
	for (uint16_t h = 0; h < 0x0400; h++) {
