...
void test_ieee_from_fp32_value_normalized_powers_of_2() {
...
void test_ieee_from_fp32_value_denormalized_powers_of_2() {
...
void test_ieee_from_fp32_value_zero() {
...
void test_ieee_from_fp32_value_infinity() {
...
void test_ieee_from_fp32_value_positive_nan() {
...
void test_ieee_from_fp32_value_negative_nan() {
...
void test_ieee_from_fp32_value_revertible() {
	/* Positive values */
...
void test_ieee_from_fp32_value_underflow() {
...
void test_ieee_from_fp32_value_overflow() {
...
void test_ieee_from_fp32_value_positive_denormalized_values() {
	const uint32_t min_nonzero_f32 = UINT32_C(0x33000001);
...
void test_ieee_from_fp32_value_negative_denormalized_values() {
	const uint32_t min_nonzero_f32 = UINT32_C(0x33000001);
...
void test_ieee_from_fp32_value_positive_normalized_values() {
...
void test_ieee_from_fp32_value_negative_normalized_values() {
	/* Minimum number that rounds to 1.0h when converted to half-precision */
	const uint32_t min_one_f32 = UINT32_C(0x3F7FF000);
	const uint32_t e_bias = 15;
